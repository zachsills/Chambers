...
/**
 * I'm too lazy to ask alex for permission to use this class, so I typed everything line
 * by line so basically this class wasn't written by him. But I'll still give that
 * kid some credit. So here it goes - this class was created by bizarrealex<br>
...
public class DataFile {
     ...
     * Will return as a default value of <tt>false</tt> if there was nothing found in the provided path
     * 
     ...
     * Will return an empty String if there was no String found in the provided path
     * 
     ...
     * Will return a list saying the path is invalid is no String List is found in the
     * provided path
     * 
     ...
     * 
     * @param path - the path you wish to find a String list at
     * @return list - a List of Strings that are in reversed order from which it was found
     */
